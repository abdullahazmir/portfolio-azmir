...
const projects: Project[] = [
  ...
  {
    slug: "fire-safety-e-commerce-website",
    name: "Fire Safety E-Commerce Website",
    image: "/projects/fire-safety.jpg",
    shortDescription:
      "An e-commerce platform for fire safety products including extinguishers, fire doors, hoses, cabinets, and accessories.",
    description:
      "An e-commerce platform for fire safety products including extinguishers, fire doors, hoses, cabinets, and accessories. Combines product catalog management with a shopping-cart driven storefront.",
    techStack: ["React", "Node.js", "Express.js", "MongoDB", "Tailwind CSS"],
    liveLink: "",
    githubClientLink: "",
    challenges: "Product management, search and filtering, shopping cart.",
    futureImprovements: "Online payment, inventory management, order tracking.",
  },
];
